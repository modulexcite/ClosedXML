...
namespace ClosedXML.Excel
{
    public class XLPivotField : IXLPivotField
    {
        ...
        {
            IncludeNewItemsInFilter = true; return this;
        }

        public IXLPivotField SetIncludeNewItemsInFilter(Boolean value)
        {
            IncludeNewItemsInFilter = value; return this;
        }
        ...
        {
            SubtotalsAtTop = true; return this;
        }

        public IXLPivotField SetSubtotalsAtTop(Boolean value)
        {
            SubtotalsAtTop = value; return this;
        }
        ...
        {
            RepeatItemLabels = true; return this;
        }

        public IXLPivotField SetRepeatItemLabels(Boolean value)
        {
            RepeatItemLabels = value; return this;
        }
        ...
        public IXLPivotField SetInsertBlankLines(Boolean value)
        {
        ...
        {
            ShowBlankItems = true; return this;
        }

        public IXLPivotField SetShowBlankItems(Boolean value)
        {
            ShowBlankItems = value; return this;
        }
        ...
        {
            InsertPageBreaks = true; return this;
        }

        public IXLPivotField SetInsertPageBreaks(Boolean value)
        {
            InsertPageBreaks = value; return this;
        }
