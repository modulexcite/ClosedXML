...
namespace ClosedXML.Excel
{
    internal class XLDrawingMargins : IXLDrawingMargins
    {
        ...
        {
            Automatic = true; return _style;
        }

        public IXLDrawingStyle SetAutomatic(Boolean value)
        {
            Automatic = value; return _style;
        }
