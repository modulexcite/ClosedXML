...
namespace ClosedXML.Excel
{
    internal class XLDrawingColorsAndLines : IXLDrawingColorsAndLines
    {
        ...
        {
            FillTransparency = value; return _style;
        }
        ...
        {
            LineTransparency = value; return _style;
        }
        ...
        {
            LineWeight = value; return _style;
        }
