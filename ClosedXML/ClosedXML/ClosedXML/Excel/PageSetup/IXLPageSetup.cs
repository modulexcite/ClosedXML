...
namespace ClosedXML.Excel
{
    ...
    public interface IXLPageSetup
    {
        ...
        /// <para>
        /// Use SetRowsToRepeatAtTop() to set the rows that will be repeated on the top of the
        /// printed pages.
        /// </para>
        /// </summary>
        ...
        /// <summary>
        /// Sets the scale at which the worksheet will be printed. This is equivalent to setting the
        /// Scale property.
        /// <para>
        /// The worksheet will be printed on as many pages as necessary to print at the given scale.
        /// </para>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether Excel will automatically adjust the font size to
        /// the scale of the worksheet.
        /// </summary>
        /// <value>
        /// <c>true</c> if Excel will automatically adjust the font size to the scale of the
        /// worksheet; otherwise, <c>false</c>.
        /// </value>
        Boolean ScaleHFWithDocument { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the header and footer margins are aligned with
        /// the left and right margins of the worksheet.
        /// </summary>
        /// <value>
        /// <c>true</c> if the header and footer margins are aligned with the left and right margins
        /// of the worksheet; otherwise, <c>false</c>.
        /// </value>
        ...
        /// </summary>
        /// <value><c>true</c> if the gridlines will be printed; otherwise, <c>false</c>.</value>
        Boolean ShowGridlines { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show row numbers and column letters/numbers.
        /// </summary>
        /// <value><c>true</c> to show row numbers and column letters/numbers; otherwise, <c>false</c>.</value>
        ...
        /// </summary>
        /// <value><c>true</c> if the worksheet will be printed in draft quality; otherwise, <c>false</c>.</value>
