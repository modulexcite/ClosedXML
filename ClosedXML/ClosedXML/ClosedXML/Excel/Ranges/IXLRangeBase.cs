...
namespace ClosedXML.Excel
{
    ...
    public interface IXLRangeBase : IDisposable
    {
        ...
        /// </para>
        /// </summary>
        /// <value>The type of the cell's data.</value>
        ...
        /// </summary>
        /// <value>If false the cell's text will not be shared and stored as an inline value.</value>
        ...
        /// <returns><c>true</c> if this range contains the specified range; otherwise, <c>false</c>.</returns>
        ...
        /// </summary>
        /// <param name="rangeAddress">The range address.</param>
        /// <returns><c>true</c> if this range intersects the specified range; otherwise, <c>false</c>.</returns>
